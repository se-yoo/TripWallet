...
<body>
	...
	%>
	<form action="addList.jsp?tId=<%=tripId %>&type=2" method="post" enctype="multipart/form-data">
		<div id="formBox">
			...
			<br> 날짜 >> <input type="date" name="sDate" value="<%=sD %>" min="<%=sD %>" max="<%=eD %>" required>&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<br> <input type="submit" value="지출추가">
		</div>
	</form>
</body>
<script>
